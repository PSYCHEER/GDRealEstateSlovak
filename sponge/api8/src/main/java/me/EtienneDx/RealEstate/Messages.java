...
public class Messages
{
    ...
    public static void sendMessage(Subject player, String msgTemplate, String... args) {
        sendMessage(player, msgTemplate, 0, args);
    }

    //sends a color-coded message to a player
    public static void sendMessage(Subject player, String msgTemplate, long delayInTicks, String... args) {
        String message = getMessage(msgTemplate, args);
        sendMessage(player, message, delayInTicks);
    }

    //sends a color-coded message to a player
    public static void sendMessage(Subject player, String message) {
        sendMessage(player, getMessage(message), 0);
    }

    public static void sendMessage(Subject player, String message, long delayInTicks) {
